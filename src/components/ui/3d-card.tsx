          ...
          <div className="relative flex flex-col justify-between rounded-xl p-4 text-white">
            ...
            <div className="flex items-start justify-between z-10">
              ...
              <motion.a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm ring-1 ring-inset ring-white/30 transition-colors hover:bg-white/30 z-20 pointer-events-auto"
              >
