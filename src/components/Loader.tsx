    ...
    >
      <div className="w-full max-w-4xl flex flex-col items-start gap-4">
        <div className="flex items-center gap-6">
          ...
          <span className="text-xs uppercase tracking-[0.3em] font-light text-gray-500">
        ...
        <div className="mt-20 w-full flex justify-between items-end">
          <div className="flex flex-col gap-2">
            <span className="text-[10px] uppercase tracking-widest text-[#FF4500]">
              System going online
            </span>
