    ...
    <div className="min-h-screen bg-[#050505] selection:bg-[#FF4500] selection:text-white overflow-x-hidden">
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          <a
            href="#"
            className="flex items-center gap-3 text-2xl font-bold tracking-tighter font-serif"
          >
            <img
              src="/logo_white.png"
              alt="Frame Forge Logo"
              className="h-8 md:h-9 w-auto max-w-[220px] object-contain"
            />
          </a>
      ...
      <section className="relative min-h-screen flex items-center justify-start overflow-hidden pt-32 pb-20 bg-[#050505]">
        ...
        <div className="absolute right-[-10%] top-[10%] md:right-[-5%] md:top-[12%] z-10 opacity-90 animate-float-right scale-75 md:scale-95 lg:scale-100 transform origin-right">
          <div className="pointer-events-none filter drop-shadow-[0_0_80px_rgba(255,255,255,0.15)] rounded-3xl overflow-hidden border border-white/10">
            <img
              src={heroMockup}
              alt="Interactive Instagram Frame Mockup"
        ...
        <div className="container mx-auto px-6 relative z-20 flex flex-col items-start justify-center h-full">
          <div id="hero-content-wrapper" className="max-w-2xl text-left">
            ...
            <div className="reveal">
              <h1
                className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight mb-8 text-white font-serif"
                style={{ textShadow: "0 0 20px rgba(255,255,255,0.1)" }}
              >
                Transform Events with <br />
                <span className="italic font-light text-[#FF4500]">
                  Visual Engagement.
                </span>
              </h1>
            </div>
            ...
            <div className="reveal" style={{ transitionDelay: "200ms" }}>
              <p className="text-lg md:text-xl text-gray-400 max-w-lg mb-12 font-light tracking-wide leading-relaxed">
                Create stunning custom frames, smart digital badges, and
                AI-generated visuals that boost attendee engagement and maximize
            ...
            <div
              className="reveal mt-16 flex items-center gap-12 text-sm text-white/40 uppercase tracking-widest font-mono"
            ...
            >
              ...
              <div>
                <div className="text-2xl font-bold text-[#FF4500] mb-2">
                  98%
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center reveal">
            ...
            <p className="text-xl md:text-2xl text-gray-500 leading-relaxed font-light">
              Everything you need to create memorable, shareable event
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto pb-32">
              ...
              <div className="reveal bg-[#1A1A1A] border border-white/5 rounded-[32px] p-2 aspect-square flex flex-col justify-start shadow-2xl hover:border-white/10 transition-all duration-500 group overflow-hidden relative">
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[28px] bg-[#0b0b0b] md:bg-transparent">
                  <img
                    src={featureAiFrames}
                    alt="AI Event Frames"
                    className="w-full h-full object-contain md:object-cover object-center opacity-60 group-hover:scale-[1.02] group-hover:opacity-80 transition-all duration-700"
                  />
                ...
                <div className="relative z-10 p-8 flex flex-col h-full justify-end">
                  ...
                  <p className="text-white/60 text-base leading-relaxed">
                    Custom-designed photo frames that perfectly match your event
                    branding and theme.
                  </p>
                </div>
              </div>
            ...
            <div className="parallax-card-up md:mt-24">
              <div
                className="reveal bg-[#111] border border-white/5 rounded-[32px] p-2 aspect-square flex flex-col justify-start shadow-2xl hover:border-[#FF4500]/50 transition-all duration-500 group overflow-hidden relative"
                style={{ transitionDelay: "150ms" }}
              >
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[28px] bg-[#0b0b0b] md:bg-transparent">
                  <img
                    src={featureSmartBadges}
                    alt="Smart Badges"
                    className="w-full h-full object-contain md:object-cover object-center opacity-60 group-hover:scale-[1.02] group-hover:opacity-80 transition-all duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-[#111]/80 to-transparent"></div>
                ...
                <div className="relative z-10 p-8 flex flex-col h-full justify-end">
                  ...
                  <p className="text-white/60 text-base leading-relaxed">
                    Digital badges that attendees can share across social
            ...
            <div className="parallax-card-down">
              <div className="reveal bg-[#111] border border-white/5 rounded-[32px] p-2 aspect-square flex flex-col justify-start shadow-2xl hover:border-white/10 transition-all duration-500 group overflow-hidden relative">
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[28px] bg-[#0b0b0b] md:bg-transparent">
                  <img
                    src={featureAiVisuals}
                    alt="AI Visuals"
                    className="w-full h-full object-contain md:object-cover object-center opacity-60 group-hover:scale-[1.02] group-hover:opacity-80 transition-all duration-700 blur-[2px] group-hover:blur-0"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-[#111]/80 to-transparent"></div>
                </div>
                ...
                <div className="relative z-10 p-8 flex flex-col h-full justify-end">
                  ...
                  <p className="text-white/60 text-base leading-relaxed">
                    Generate stunning AI-powered graphics and imagery for your
                    event materials.
                  </p>
                </div>
              </div>
            ...
            <div className="parallax-card-up md:mt-24">
              <div
                className="reveal bg-[#1A1A1A] border border-white/5 rounded-[32px] p-2 aspect-square flex flex-col justify-start shadow-2xl hover:border-[#FF4500]/50 transition-all duration-500 group overflow-hidden relative"
                style={{ transitionDelay: "150ms" }}
              >
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[28px] bg-[#0b0b0b] md:bg-transparent">
                  <img
                    src={featureCustomDesign}
                    alt="Custom Design"
                    className="w-full h-full object-contain md:object-cover object-center opacity-60 group-hover:scale-[1.02] group-hover:opacity-80 transition-all duration-700 grayscale group-hover:grayscale-0"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-[#111]/80 to-transparent"></div>
                </div>
                ...
                <div className="relative z-10 p-8 flex flex-col h-full justify-end">
                  ...
                  <p className="text-white/60 text-base leading-relaxed">
                    Full-service creative design tailored to your brand and
                    event requirements.
                  </p>
                </div>
              </div>
