...
const serviceHighlights = [
  { title: "FRAMES", image: "/feature-ai-frames.png" },
  { title: "BADGES", image: "/feature-smart-badges.png" },
  { title: "AI VISUALS", image: "/feature-ai-visuals.jpeg" },
  { title: "CUSTOM DESIGN", image: "/feature-custom-design.png" },
];
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20 bg-[#050505]">
        ...
        <div
          className="absolute top-[16%] md:top-[18%] z-10 opacity-80 origin-top-left -rotate-6 animate-float-left scale-90"
          style={{ perspective: "1000px", left: "clamp(12px, 3vw, 56px)" }}
        >
        ...
        <div
          className="absolute bottom-[5%] right-[2%] md:bottom-[8%] md:right-[4%] z-10 opacity-80 origin-bottom-right rotate-6 animate-float-right scale-90"
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center reveal">
            ...
            <p className="text-xl md:text-2xl text-gray-500 leading-relaxed font-light">
              We provide the visual tools so your attendees resonate with your
              brand and become your best marketers.
            </p>
          </div>

          {/* Service Highlights */}
          <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            {serviceHighlights.map((item, idx) => (
              <div
                key={item.title}
                className="reveal group rounded-2xl border border-white/10 bg-[#0f0f0f] overflow-hidden transition-all duration-300 hover:border-[#FF4500]/60 hover:shadow-[0_16px_40px_rgba(255,69,0,0.2)]"
                style={{ transitionDelay: `${idx * 100}ms` }}
              >
                <img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-32 object-cover object-center transition-transform duration-500 group-hover:scale-105"
                  loading="lazy"
                  decoding="async"
                />
                <div className="px-4 py-4 text-center">
                  <p className="font-bold text-sm md:text-base tracking-[0.16em] text-[#FF6A1A] drop-shadow-[0_0_8px_rgba(255,106,26,0.45)] transition-all duration-300 group-hover:text-[#FF8C42] group-hover:drop-shadow-[0_0_14px_rgba(255,106,26,0.7)] group-hover:animate-glow">
                    {item.title}
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="parallax-card-up md:mt-24">
              <div
                className="reveal bg-[#111] border border-white/10 rounded-3xl p-8 md:p-12 aspect-[4/5] flex flex-col justify-between shadow-2xl group cursor-pointer hover:border-[#FF4500]/50 transition-all duration-500"
